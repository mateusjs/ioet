...
class TestUtils(unittest.TestCase):
    ...
    def test_should_get_days_of_work_with_file_bad_formation_error(self):
        ...
        self.assertTrue('File has bad formation, validate your data' in str(context.exception))
    ...
    def test_should_get_hours_with_attribute_error(self):
        with self.assertRaises(AttributeError) as context:
            get_hours(None)
        self.assertTrue("'NoneType' object has no attribute 'split'" in str(context.exception))


        #faltou teste do shift